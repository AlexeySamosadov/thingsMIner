...
const givers_1 = require("./givers_chipi");
...
function sendMinedBoc(wallet, seqno, keyPair, giverAddress, boc) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // const tonOrbsClient = yield (0, client_1.getTon4ClientOrbs)(); // Удалите или закомментируйте эту строку, если функция не нужна
        const w2 = ton4Client.open(wallet);
        wallets.push(w2);
        // const w3 = tonOrbsClient.open(wallet); // Удалите или закомментируйте эту строку, если функция не нужна
        // wallets.push(w3);
        if (args['--api'] === 'lite') {
